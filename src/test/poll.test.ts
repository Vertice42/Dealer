...
import { createStreamerDatabase, ID_FOR_MANAGER_POLL, deleteStreamerDatabase, db_PRE_CREATED, db_FOR_UPDATE_BUTTONS, createPoll, startPoll, ID_FOR_DISTRIBUITION, USERS_IDS_FOR_TESTS, ID_FOR_DISTRIBUTION_OF_MULTIPLE_RESULTS } from "./ForTests.test";

describe('Poll', () => {
    before(async function () {
      await createStreamerDatabase(ID_FOR_MANAGER_POLL);
    });
    ...
    describe('Update Buttons', function () {
      ...
      before(async function () {
        await createStreamerDatabase(db_FOR_UPDATE_BUTTONS);
    ...
    describe('Distribution', function () {
      ...
      before(async () => {
        await createStreamerDatabase(ID_FOR_DISTRIBUITION);
        ...
        await createStreamerDatabase(ID_FOR_DISTRIBUTION_OF_MULTIPLE_RESULTS);
