...
describe('Poll', () => {
  ...
  it('Start Poll', async function () {
    ...
    let pollControl = new PollController(ID_FOR_MANAGER_POLL);

    let UpdatePollResult = await pollControl.UpdatePoll((await pollControl.getCurrentPollStatus()).start(), ButtonsToTest)
  ...
  it('Get Poll', async function () {
    ...
    PollStatusExpected.updatedAt = poll.PollStatus.updatedAt;
    PollStatusExpected.DistributionStatisticsJson = null;
  ...
  describe('Update Buttons', function () {
    ...
    it('Modify buttons', async function () {
      ...
      PollStatusForTest.DistributionStatisticsJson = null;
      PollStatusForTest.updatedAt = poll.PollStatus.updatedAt;
