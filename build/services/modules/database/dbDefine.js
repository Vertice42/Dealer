...
class Define {
    ...
    static CurrentBettings(AccountData) {
        return __awaiter(this, void 0, void 0, function* () {
            AccountData.dbCurrentBettings = AccountData.dbStreamer.define(AccountData.CurrentBettingsID, dbBettings_1.BettingsDefiner.atributes, dbBettings_1.BettingsDefiner.options);
