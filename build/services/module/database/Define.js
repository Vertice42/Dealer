...
const dbWallet_1 = require("./models/dbWallet");
const dbWishes_1 = require("./models/dbWishes");
const dbSettings_1 = require("./models/dbSettings");
const dbButton_1 = require("./models/dbButton");
class Define {
